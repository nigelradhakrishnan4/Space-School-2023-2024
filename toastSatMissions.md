# Introduction 
Welcome to your toastSat missions in Space School! In this meeting, we look at the wide breadth of mission types on how satellites are used in order to gain some inspiration for developing our own simplified missions. We are then introduced to the design constraints and information regarding the balloon launch in order to guide our thoughts and implementation of our sensor suite. 

# Meeting Goals

1️⃣ Determine mission for toastSat payload. 

2️⃣ Identtify necessary payload sensors

3️⃣ Consider constraints on the toastSat payload, including weight, power, etc.
